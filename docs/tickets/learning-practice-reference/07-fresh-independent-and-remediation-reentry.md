# 07 — Fresh Independent 与失败后的重新 remediation

**What to build:** remediation 后的 Independent Test 相对于所有已暴露题目、例题、Hint Ladder 和 reveal 都是 Fresh Equivalent；Independent 的不同结果正确进入 Evidence、replacement 或新的 remediation。
