 ...
 * {@code assistance_decided}, {@code continue_requested}, or
 * {@code flow_control_requested}. Every command carries the expected
 * {@code interactionVersion}; commands targeting an open Attempt also carry
 * {@code attemptId}. {@code answer_submitted} reuses the existing raw answer,
