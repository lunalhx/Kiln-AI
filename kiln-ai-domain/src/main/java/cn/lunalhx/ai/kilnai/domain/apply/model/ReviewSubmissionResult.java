 ...
 * interval (or ends the cadence at Review 4). An Inconclusive assessment
 * closes the submitted Attempt but accepts no Evidence and changes no
 * milestone or cadence position: it binds a new verified Fresh Equivalent
 * Attempt to the same Started Review Task ({@link ReplacementBound}) or, when
 * the replacement cannot be prepared, leaves the Review Started and resumable
