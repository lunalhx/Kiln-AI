 ...
 * one Independent Evidence record and projects the updated Concept Progress.
 * The learner-visible surface is only the safe continue-or-end message; the
 * closed attempt and evidence are private audit data for the Graph layer,
 * and answers, assessment conclusions, sources, Fingerprints, and audit
